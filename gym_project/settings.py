...
SECRET_KEY = 'django-insecure-89y8f^%u#7b8hryfk6g$_*_=_5a=emc5eiti_z&g8ez!u0+v(0'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'gym_app/static')]
